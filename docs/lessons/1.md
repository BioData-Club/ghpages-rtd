...
Of course it is important to choose an image with an original size that resolution that will look good on screen.  We don't recommend englarging smaller images, as they are likely to look pixelated.  It's better to choose a larger image an then crop or resize it as needed.
### Further Reading
